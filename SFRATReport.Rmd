...
##DATA PREPROCESSING
<<<<<<< HEAD
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/utility/data/Data_Tools.R')
=======
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/utility/data/Data_Tools.R')
>>>>>>> origin/master
...
<<<<<<< HEAD
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/DSS/DSS_BM_FT.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/DSS/Model_specifications.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/GO/GO_BM_FT.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/GO/Model_specifications.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/JM/JM_BM.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/JM/Model_specifications.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/GM/GM_BM.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/GM/Model_specifications.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/Wei/Wei_NM_FT.R')
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/models/Wei/Model_specifications.R')
=======
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/DSS/DSS_BM_FT.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/DSS/Model_specifications.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/GO/GO_BM_FT.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/GO/Model_specifications.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/JM/JM_BM.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/JM/Model_specifications.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/GM/GM_BM.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/GM/Model_specifications.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/Wei/Wei_NM_FT.R')
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/models/Wei/Model_specifications.R')
>>>>>>> origin/master
```
...
```
Models `r models` successfully characterized the input data. The staircase plot indicates the input data and models that closely matches the input data are preferred.
...
```{r,echo=FALSE}
<<<<<<< HEAD
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/utility/prediction/Detailed_prediction.R')
=======
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/utility/prediction/Detailed_prediction.R')
>>>>>>> origin/master
...
thirdCol <- c()
if('DSS' %in% models) { 
  thirdCol=append(thirdCol,get_prediction_t("DSS",DSS_BM_MLE(FT),num_failures_to_predict,last(FT),length(FT)))
}

if('GO' %in% models) {
  thirdCol=append(thirdCol,get_prediction_t("GO",GO_BM_MLE(FT),num_failures_to_predict,last(FT),length(FT)))
}

if('JM' %in% models) { 
  thirdCol=append(thirdCol,get_prediction_t("JM",JM_BM_MLE(IF),num_failures_to_predict,last(FT),length(FT)))
}

if('GM' %in% models) {
  thirdCol=append(thirdCol,get_prediction_t("GM",GM_BM_MLE(IF),num_failures_to_predict,last(FT),length(FT)))
}

if('Wei' %in% models) { 
  thirdCol=append(thirdCol,get_prediction_t("Wei",Wei_NM_MLE(FT),num_failures_to_predict,last(FT),length(FT)))
}
...
<<<<<<< HEAD
kable(predTable,align='r',digits=2)
=======
kable(predTable,align='r')
>>>>>>> origin/master
```
...
After applying one or more models to a set of failure data, the user can assess which model or models produce better predictions. This version of the SFRAT includes two methods to evaluate the performance of the models to identify those that will provide better predictions – the Akaike Information Criterion (AIC) and Predictive Sum of Squared Error (PSSE).

```{r,echo=FALSE}

<<<<<<< HEAD
source('/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master-3/SFRAT/utility/metrics/GOF.R')
=======
source('C:/Users/vnagaraju/Downloads/SFRAT_Automated-Report-Generation-master/SFRAT_Automated-Report-Generation-master/SFRAT/utility/metrics/GOF.R')
>>>>>>> origin/master
#Setup Table
...
#Setting Up The Table
predTable <- matrix(NA, nrow = length(models)*num_failures_to_predict , ncol = 3)
rownames(predTable) <- rep(models,num_failures_to_predict)#sort(rep(models,num_failures_to_predict))
colnames(predTable) <- c("Time to achieve specified reliability","Expected number of failures","Expected time to N failure")

##Calulating Future Failures
#Time to achieve specified reliability
options(digits=4)
 #First column of prediction table

firstCol <- c()
for (i in 1:num_failures_to_predict) { 
 if('DSS' %in% models) { 
  firstCol=append(firstCol,get_reliability_t("DSS",DSS_BM_MLE(FT),desired_reliability,reliability_interval_length,last(FT),i))
 }

if('GO' %in% models) {
  firstCol=append(firstCol,get_reliability_t("GO",GO_BM_MLE(FT),desired_reliability,reliability_interval_length,last(FT),i))
}

if('JM' %in% models) { 
  firstCol=append(firstCol,get_reliability_t("JM",JM_BM_MLE(IF),desired_reliability,reliability_interval_length,last(IF),i))
}

if('GM' %in% models) {
  firstCol=append(firstCol,get_reliability_t("GM",GM_BM_MLE(IF),desired_reliability,reliability_interval_length,last(FT),i))##The right hand side is creating a null model. TODO: Refer back to the original file to solve this precision issue
}

if('Wei' %in% models) { 
  firstCol=append(firstCol,get_reliability_t("Wei",Wei_NM_MLE(FT),desired_reliability,reliability_interval_length,last(FT),i))
}
i=i+1;
} 
predTable[,1] <- firstCol 
